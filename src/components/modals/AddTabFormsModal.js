    ...
    <Modal isOpen={isOpen} onClose={onClose}>
      ...
      <ModalContent borderColor={borderColor} borderWidth="1px" borderRadius="md">
        ...
        <form onSubmit={handleFormSubmit}>
          <ModalBody>
            <Grid templateColumns="repeat(1, 1fr)" gap={6}>
              ...
              <FormControl id="size">
                ...
                <Select placeholder="Select Size" name="size" required borderColor={borderColor} _hover={{ borderColor: hoverColor }}>
          ...
          <ModalFooter>
            <Grid templateColumns="repeat(2, 2fr)" templateRows="repeat(1fr, 1fr)" width='100%' gap={6}>
              <IconButton
                type="submit"
                colorScheme="blue"
                icon={<CheckIcon />}
